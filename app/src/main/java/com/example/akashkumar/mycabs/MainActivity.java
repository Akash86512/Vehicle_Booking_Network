    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            else
            {
                ...
                Intent intent = new Intent(this, NameGmail.class);
...
//            DatabaseReference myRef = database.getReference(mPhoneNumberField.getText().toString());
//
//            String phone1=mPhoneNumberField.getText().toString();
//            String   name1=name.getText().toString();
//            String  gmail1=gmail.getText().toString();
//
//
//           /* mydata=new MyCoreDatabase(this);
//            mydata.insertdata(phone1,name1,gmail1);*/
//
//
//            phoneclass phoneclass=new phoneclass(phone1,name1,gmail1);
//
//            myRef.child(phone1).setValue(phoneclass);
//            Toast.makeText(this," data is save jhbjhbjh h bjhb  suceesfulll ",Toast.LENGTH_LONG).show();
