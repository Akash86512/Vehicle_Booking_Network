...
public class FourSeater extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        setContentView(R.layout.activity_four_seater);
    ...
    void book()
    {
...

        {
            ...
            if(price_km==0)
            {
                ...
                Intent intent=new Intent(FourSeater.this,BookingActivity.class);
                ...
                intent.putExtra("seater","4 Seater Booking");
