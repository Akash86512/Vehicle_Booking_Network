...
public class Bus extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    void book()
    {
...

        {
            ...
            if(price_km==0)
            {
                ...
                Intent intent=new Intent(Bus.this,BookingActivity.class);
                ...
                intent.putExtra("seater","BUS Booking");
