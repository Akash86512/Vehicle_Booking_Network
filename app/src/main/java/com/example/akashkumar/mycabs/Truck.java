...
public class Truck extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    void book()
    {
...

        {
            ...
            if(price_km==0)
            {
                ...
                Intent intent=new Intent(Truck.this,BookingActivity.class);
                ...
                intent.putExtra("seater","Truck Booking");
