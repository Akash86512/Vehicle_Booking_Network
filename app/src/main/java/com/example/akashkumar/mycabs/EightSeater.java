...
public class EightSeater extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                ...
                .build();
        setContentView(R.layout.activity_eight_seater);
    ...
    void book()
    {
...

        {
            ...
            if(price_km==0)
            {
                ...
                Intent intent=new Intent(EightSeater.this,BookingActivity.class);
                ...
                intent.putExtra("seater","8 Seater Booking");
