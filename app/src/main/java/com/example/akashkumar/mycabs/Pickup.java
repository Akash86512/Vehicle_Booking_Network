...
public class Pickup extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    void book()
    {
...

        {
            ...
            if(price_km==0)
            {
                ...
                Intent intent=new Intent(Pickup.this,BookingActivity.class);
                ...
                intent.putExtra("seater","Pickup Booking");
